      ...
      <img id="full-logo-img" src="logo.png" >
            ...
            <form role="form" action="#" method="post" class=" form-signin form-inline ">
              ...
              <div class="btn-group btn-group-justified">
                <input  class="btn btn-primary"  type="submit"  value="בדיקת מעבדה">
                <input class="btn btn-primary " type="submit" value="חקירה" >
                <input class="btn btn-primary"  type="submit"value="בקרה">
                <input  class="btn btn-primary"  type="submit" value="עדכון ממצאי הבדיקה" >
              </div>
                </div>
                <hr class="m-y-2">
                ...
                <div class=" form-group  input-container dir-rtl " >
                              <div class="btn-group btn-group-justified ">
                                    <input  class="btn btn-primary" type="submit" name="" value="חזור">
