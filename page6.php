    ...
    <div class="container">
        ...
        <div class="container">
          ...
          <div class="panel-heading text-center ">
            ...
            <hr class="m-y-2">
                ...
                <h5 class="dir-rtl" >סגירת תלונה </h5>
      ...
      <div class="panel-body">
          ...
          <p>
            ...
            <img src="Symbol_OK.svg" alt="" id="full-logo-img">

            <h6>התלונה נקלטה בהצלחה!</h6>
          ...
          <div class=" container form-group form-row mx-auto">
            ...
            <label for=""> ניתן לבצע את הפעולות הבאות:</label>
          <p>
              ...
              <div class="container">
                 <input type="button"  class="btn btn-primary  d-block" name="" value="לחץ כאן">
